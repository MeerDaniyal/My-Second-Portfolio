        ...
        <div className="md:w-1/2 w-full  mx-auto md:mx-0 space-y-6 flex justify-center md:justify-center md:items-center">
          <div className="md:space-y-8 space-y-3 text-2xl md:2xl mt-8 text-center md:text-start">
            <p>
              ...
              <a href="tel:03477887701" className="hover:underline">
                {" "}
                03477887701
              </a>
            </p>
            <p>
              ...
              <a href="meerdaniyal544@@GMAIL.COM" className="hover:underline">
                {" "}
                meerdaniyal544@gmail.com
              </a>
            </p>
            <p>
            ...
            <div className="flex md:justify-start justify-center py-2 rounded-lg w-full">
              <Link
                href="https://www.facebook.com/sheikhmuhammad.daniyal.1?mibextid=ZbWKwL"
                target="_blank"
              >
                <FaFacebookF className="text-2xl hover:text-blue-500 mr-4" />
              </Link>
              <Link
                href="https://www.linkedin.com/in/meer-daniyal/"
                target="_blank"
              >
                <FaLinkedinIn className="text-2xl hover:text-blue-700 mr-4" />
              </Link>
              <Link href="https://github.com/MeerDaniyal" target="_blank">
