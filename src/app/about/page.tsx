      ...
      <section className="text-white md:h-fit">
        <div className="container mx-auto px-6">
          ...
          <div>
            ...
            I am currently in the second quarter of an Artificial Intelligence course, having successfully cleared the first quarter with a 75 percentile. My journey continues as I Enhance My Skills In Both AI And Front-end Development
